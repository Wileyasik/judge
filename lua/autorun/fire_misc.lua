...
local function PrecacheIfExists(system)
	if file.Exists("particles/" .. system .. ".pcf", "GAME") then
		PrecacheParticleSystem(system)
	end
end

AddParticlesIfExists("particles/vFire_Base_Tiny.pcf")
AddParticlesIfExists("particles/vFire_Base_Small.pcf")
AddParticlesIfExists("particles/vFire_Base_Medium.pcf")
AddParticlesIfExists("particles/vFire_Base_Big.pcf")
AddParticlesIfExists("particles/vFire_Base_Huge.pcf")
AddParticlesIfExists("particles/vFire_Base_Gigantic.pcf")
AddParticlesIfExists("particles/vFire_Base_Inferno.pcf")

AddParticlesIfExists("particles/vFire_Base_Tiny_LOD.pcf")
AddParticlesIfExists("particles/vFire_Base_Small_LOD.pcf")
AddParticlesIfExists("particles/vFire_Base_Medium_LOD.pcf")
AddParticlesIfExists("particles/vFire_Base_Big_LOD.pcf")
AddParticlesIfExists("particles/vFire_Base_Huge_LOD.pcf")
AddParticlesIfExists("particles/vFire_Base_Gigantic_LOD.pcf")
AddParticlesIfExists("particles/vFire_Base_Inferno_LOD.pcf")

AddParticlesIfExists("particles/vFire_Flames_Tiny.pcf")
AddParticlesIfExists("particles/vFire_Flames_Small.pcf")
AddParticlesIfExists("particles/vFire_Flames_Medium.pcf")
AddParticlesIfExists("particles/vFire_Flames_Big.pcf")
AddParticlesIfExists("particles/vFire_Flames_Huge.pcf")
AddParticlesIfExists("particles/vFire_Flames_Gigantic.pcf")
AddParticlesIfExists("particles/vFire_Flames_Inferno.pcf")

AddParticlesIfExists("particles/vFire_Flames_Tiny_LOD.pcf")
AddParticlesIfExists("particles/vFire_Flames_Small_LOD.pcf")
AddParticlesIfExists("particles/vFire_Flames_Medium_LOD.pcf")
AddParticlesIfExists("particles/vFire_Flames_Big_LOD.pcf")
AddParticlesIfExists("particles/vFire_Flames_Huge_LOD.pcf")
AddParticlesIfExists("particles/vFire_Flames_Gigantic_LOD.pcf")
AddParticlesIfExists("particles/vFire_Flames_Inferno_LOD.pcf")


AddParticlesIfExists("particles/vFire_Burst_Infant.pcf")
AddParticlesIfExists("particles/vFire_Burst_Lines.pcf")
AddParticlesIfExists("particles/vFire_Burst_Main.pcf")
AddParticlesIfExists("particles/vFire_Burst_Main_Big.pcf")
AddParticlesIfExists("particles/vFire_Burst_Plume.pcf")
AddParticlesIfExists("particles/vFire_Burst_Trail.pcf")
AddParticlesIfExists("particles/vFire_Burst_Trail_Plume.pcf")


PrecacheIfExists("vFire_Base_Tiny")
PrecacheIfExists("vFire_Base_Small")
PrecacheIfExists("vFire_Base_Medium")
PrecacheIfExists("vFire_Base_Big")
PrecacheIfExists("vFire_Base_Huge")
PrecacheIfExists("vFire_Base_Gigantic")
PrecacheIfExists("vFire_Base_Inferno")

PrecacheIfExists("vFire_Base_Tiny_LOD")
PrecacheIfExists("vFire_Base_Small_LOD")
PrecacheIfExists("vFire_Base_Medium_LOD")
PrecacheIfExists("vFire_Base_Big_LOD")
PrecacheIfExists("vFire_Base_Huge_LOD")
PrecacheIfExists("vFire_Base_Gigantic_LOD")
PrecacheIfExists("vFire_Base_Inferno_LOD")

PrecacheIfExists("vFire_Flames_Tiny")
PrecacheIfExists("vFire_Flames_Small")
PrecacheIfExists("vFire_Flames_Medium")
PrecacheIfExists("vFire_Flames_Big")
PrecacheIfExists("vFire_Flames_Huge")
PrecacheIfExists("vFire_Flames_Gigantic")
PrecacheIfExists("vFire_Flames_Inferno")

PrecacheIfExists("vFire_Flames_Tiny_LOD")
PrecacheIfExists("vFire_Flames_Small_LOD")
PrecacheIfExists("vFire_Flames_Medium_LOD")
PrecacheIfExists("vFire_Flames_Big_LOD")
PrecacheIfExists("vFire_Flames_Huge_LOD")
PrecacheIfExists("vFire_Flames_Gigantic_LOD")
PrecacheIfExists("vFire_Flames_Inferno_LOD")


PrecacheIfExists("vFire_Burst_Infant")
PrecacheIfExists("vFire_Burst_Lines")
PrecacheIfExists("vFire_Burst_Main")
PrecacheIfExists("vFire_Burst_Main_Big")
PrecacheIfExists("vFire_Burst_Plume")
PrecacheIfExists("vFire_Burst_Trail")
PrecacheIfExists("vFire_Burst_Trail_Plume")
