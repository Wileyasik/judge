...
hg.armor.face = {
	...
	["mask1"] = {
		"face", -- "face"
		"models/eft/gear/facecover/facecover_ballistic_mask.mdl",
		Vector(4.35, -0.8, 0),
		Angle(180, 90, 90),
		protection = 14,
		meleeProt = 14,
		...
		bone = "ValveBiped.Bip01_Head1",
		model = "models/eft/gear/facecover/facecover_ballistic_mask_bp02.mdl",
		models = {
			"models/eft/gear/facecover/facecover_ballistic_mask.mdl",
			"models/eft/gear/facecover/facecover_ballistic_mask_bp02.mdl",
			"models/eft/gear/facecover/facecover_ballistic_mask_bp01.mdl",
			"models/eft/gear/facecover/facecover_ballistic_mask_bp03.mdl",
			"models/eft/gear/facecover/facecover_ballistic_mask_bp06.mdl",
			"models/eft/gear/facecover/facecover_ballistic_mask_toxic.mdl",
			"models/eft/gear/facecover/facecover_ballistic_mask_demon.mdl",
			"models/eft/gear/facecover/facecover_ballistic_mask_bp07.mdl",
		},
		restricted = {"head"},
