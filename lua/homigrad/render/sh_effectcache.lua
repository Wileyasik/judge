...
PrecacheIfExists("pcf_jack_airsplode_small", { "particles/pcfs_jack_explosions_small.pcf", "particles/pcfs_jack_explosions_small3.pcf" })
PrecacheIfExists("pcf_jack_airsplode_small3", { "particles/pcfs_jack_explosions_small3.pcf", "particles/pcfs_jack_explosions_small.pcf" })
