...
util.AddNetworkString("hg_stop_custom_tinnitus")
function plymeta:PlayCustomTinnitus(snd)
	if not IsValid(self) or not snd or snd == "" then return end
...
function plymeta:StopCustomTinnitus()
	...
	net.Start("hg_stop_custom_tinnitus")
	net.Send(self)
end
