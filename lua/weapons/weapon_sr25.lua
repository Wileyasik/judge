...
SWEP.ModularParts = {
	...
	handguard = {
		model = "models/weapons/mods/handguard_ar10_kac_urx4_14_5_inch.mdl",
		bonemerge = false,
		bone = "weapon",
		pos = Vector(0, -17.25, 0.15),
		ang = Angle(0, 0, 0)
	},
	pistolgrip = {
...
SWEP.LocalMuzzlePos = Vector(26.2, -1.75, 4.2)
...
SWEP.availableAttachments = {
	...
	sight = {
		["mountType"] = {"picatinny"},
		["mount"] = {["picatinny"] = Vector(-22, 1.4, 0.05)},
	},
	grip = {
