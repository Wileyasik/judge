...
SWEP.AttachmentPos = Vector(1.7, 0, -0)
SWEP.AttachmentAng = Angle(0, 0, 0)
SWEP.FakeAttachment = "1"
SWEP.FakeBodyGroups = "11111124101002"
SWEP.ZoomPos = Vector(0, -1.7568, 6.025)
...
SWEP.WepSelectIcon2 = Material("entities/arc9_eft_g28.png")
SWEP.IconOverride = "entities/arc9_eft_g28.png"
...
SWEP.availableAttachments = {
	...
	sight = {
		["mountType"] = {"picatinny"},
		["mount"] = {["picatinny"] = Vector(-24, 1.4, 0.05)},
	},
	grip = {
