...
SWEP.Author = "CMMG"
SWEP.Instructions = "Selective-fire assault rifle chambered in 7.62x39 mm\n\nRate of fire 700 rounds per minute"
...
SWEP.WorldModelFake = "models/weapons/c_mk47.mdl"


SWEP.ModularParts = {
	magazine = {
		model = "models/weapons/mods/mag_ak_ultimag.mdl",
		bonemerge = false,
		bone = "mod_magazine",
		pos = Vector(0, 1, 0),
		ang = Angle(0, 0, 0)
	...
	stock = {
		...
		bonemerge = false,
		bone = "weapon",
		pos = Vector(0, -8.8, 0.05),
		ang = Angle(0, -90, 0)
	},
	stock1 = {
		model = "models/weapons/mods/stock_ar15_fab_defense_gl_core_s.mdl",
		bonemerge = false,
		bone = "weapon",
		pos = Vector(0, -6.75, -0.85),
		ang = Angle(0, -90, 0)
	},
	pistolgrip = {
		model = "models/weapons/mods/pistolgrip_ar15_hk_battle_grip.mdl",
		bonemerge = false,
		bone = "weapon",
	...
	handguard = {
		model = "models/weapons/mods/handguard_ar10_cmmg_mk3_rml15.mdl",
		bonemerge = false,
		bone = "weapon",
		pos = Vector(0, -17.3, 0.15),
		ang = Angle(0, 0, 0)
	},
}
...
SWEP.AttachmentPos = Vector(5.3, 0, 0)
SWEP.AttachmentAng = Angle(0, 0, 0)
SWEP.FakeAttachment = "1"
SWEP.FakeBodyGroups = "11121"
SWEP.ZoomPos = Vector(0, -1.7587, 5.8968)
...
SWEP.AnimList = {
	...
	["idle"] = "idle",
	["reload"] = "reload_762",
	["reload_empty"] = "reload_empty_762",
	["inspect"] = "inspect0",
}

SWEP.MagazineReloadAnimations = {
	mag6 = {"reload_drum", "reload_empty_drum"},
}
...
SWEP.LocalMuzzlePos = Vector(21.5, -1.75, 4.1)
SWEP.LocalMuzzleAng = Angle(0, 0, 0)
SWEP.WeaponEyeAngles = Angle(0, 0, 0)

SWEP.HoldType = "rpg"

SWEP.WepSelectIcon2 = Material("entities/arc9_eft_mk47_mutant.png")
SWEP.IconOverride = "entities/arc9_eft_mk47_mutant.png"
...
SWEP.availableAttachments = {
	...
	barrel = {
		...
		["mount"] = Vector(-0.55, 0.05, 0),
	},
	sight = {
		["mountType"] = {"picatinny"},
		["mount"] = {["picatinny"] = Vector(-20, 1.35, 0.05)},
	},
	grip = {
