...
SWEP.Author = "Brügger & Thomet"
SWEP.Instructions = "Machine pistol chambered in 9x19 mm\n\nRate of fire 900 rounds per minute"
...
SWEP.WorldModelFake = "models/weapons/c_mp9.mdl"

SWEP.ModularParts = {
	magazine = {
		model = "models/weapons/mods/mag_mp9_25.mdl",
		bonemerge = false,
		bone = "mod_magazine",
		pos = Vector(0, 3.8, -3),
		ang = Angle(0, -90, 0)
...
SWEP.HeldMagOffsetPos = Vector(0, 0.1, 0)
SWEP.HeldMagOffsetAng = Angle(0, -90, 0)

SWEP.FakePos = Vector(-13, 2.0, 7.5)
SWEP.FakeAng = Angle(0, -0, 0)
SWEP.AttachmentPos = Vector(-1, 0, 0)
SWEP.AttachmentAng = Angle(0, 0, 0)
SWEP.FakeAttachment = "1"
SWEP.FakeBodyGroups = "11111100211"
SWEP.ZoomPos = Vector(0, -2.3136, 6.0442)
...
SWEP.AnimsEvents = {
    ...
    ["reload"] = {
        [0.10] = function(self) self:EmitSound("weapons/darsu_eft/mp9/fiveseven_mag_out.ogg") end,
		...
		[0.45] = function(self) self:EmitSound("weapons/darsu_eft/mp9/fiveseven_mag_in.ogg") end,

    },
    ["reload_empty"] = {
        [0.10] = function(self) self:EmitSound("weapons/darsu_eft/mp7/mp7_mag_button.ogg") end,
        [0.15] = function(self) self:EmitSound("weapons/darsu_eft/mp9/fiveseven_mag_out.ogg") end,
		[0.23] = function(self) self:EmitSound("arc9_eft_shared/generic_mag_pouch_out3.ogg") end,
		[0.45] = function(self) self:EmitSound("weapons/darsu_eft/mp9/fiveseven_mag_in.ogg") end,
		[0.65] = function(self) self:EmitSound("weapons/darsu_eft/mp7/mp7_mag_button.ogg") end,
    },
}
...
SWEP.MagModel = "models/weapons/mods/mag_mp9_30.mdl"
...
SWEP.animposmul = 2
SWEP.Primary.Sound = {"weapons/darsu_eft/mp9/fire_new/mp9_outdoor_close_loop1.wav", 75, 120, 130}
SWEP.SupressedSound = {"weapons/darsu_eft/mp9/fire_new/mp9_outdoor_close_loop_silenced1.wav", 65, 90, 100}
...
SWEP.LocalMuzzlePos = Vector(8.8, -2.3, 4.5)
SWEP.LocalMuzzleAng = Angle(0.4, 0.09, 0)
SWEP.WeaponEyeAngles = Angle(0, 0, 0)

SWEP.HoldType = "rpg"

SWEP.WepSelectIcon2 = Material("entities/arc9_eft_mp9n.png")
SWEP.IconOverride = "entities/arc9_eft_mp9n.png"
...
SWEP.availableAttachments = {
	barrel = {
		...
		["mount"] = Vector(-0.45, 0.05, 0.05),
	},
	sight = {
		["mountType"] = {"picatinny"},
		["mount"] = Vector(-7.3, 1.2, 0.05),
	},
	underbarrel = {
		["mount"] = Vector(10, 0.4, 0.1),
