...
SWEP.WorldModelFake = "models/weapons/c_sig_mpx2.mdl"

SWEP.ModularParts = {
	magazine = {
		model = "models/weapons/mods/mag_mpx_30.mdl",
		bonemerge = false,
		bone = "mod_magazine",
		pos = Vector(0, 2.4, 0),
		ang = Angle(0, -90, 0)
	...
	handguard = {
		model = "models/weapons/mods/handguard_mpx_sig_mpx_gen1_8_inch.mdl",
		bonemerge = false,
		bone = "weapon",
		pos = Vector(0, -16.76, -0.968),
		ang = Angle(0, -90, 0)
	},
	pistolgrip = {
	...
	stock = {
		model = "models/weapons/mods/stock_all_sig_mpx_brace.mdl",
		bonemerge = false,
		bone = "weapon",
		pos = Vector(0, -8, 0.4),
		ang = Angle(0, -90, 0)
...
SWEP.FakeBodyGroups = "11111500"
SWEP.ZoomPos = Vector(0, -2.2694, 5.8234)
...
SWEP.MagModel = "models/weapons/mods/mag_mpx_30.mdl"
...
SWEP.LocalMuzzlePos = Vector(15.1, -2.3, 4.1)
SWEP.LocalMuzzleAng = Angle(0, 0, 0)
SWEP.WeaponEyeAngles = Angle(0, 0, 0)

SWEP.HoldType = "rpg"

SWEP.WepSelectIcon2 = Material("entities/arc9_eft_mpx.png")
SWEP.IconOverride = "entities/arc9_eft_mpx.png"
...
SWEP.availableAttachments = {
	...
	sight = {
		["mountType"] = {"picatinny"},
		["mount"] = Vector(-13, 1.5, 0.05),
	},
	grip = {
		["mount"] = {["picatinny"] = Vector(10, 0.4, 0.1)},
		["mountType"] = {"picatinny"},
		["mountAngle"] = Angle(0,0,0)
	},
	underbarrel = {
		["mount"] = Vector(9, -0.2, 0.1),
...
SWEP.DistSound = path .. "mpx_fire_close.ogg"
