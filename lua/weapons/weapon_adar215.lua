...
SWEP.Author = "Molot Arms"
SWEP.Instructions = "Civilian semi-automatic rifle chambered in 5.56x45 mm\n\nRate of fire 600 rounds per minute"
...
SWEP.ModularParts = {
	receiver = {
		model = "models/weapons/mods/reciever_ar15_adar_2-15_std.mdl",
		bonemerge = false,
		bone = "mod_reciever",
		pos = Vector(0, 0, 0),
		ang = Angle(0, -90, 0)
	...
	magazine = {
		model = "models/weapons/mods/mag_stanag_hk_gen_2_pm_556x45_30.mdl",
		bonemerge = false,
		bone = "mod_magazine",
		pos = Vector(0, 1.1, 0),
		ang = Angle(0, -90, 0)
	...
	stock2 = {
		model = "models/weapons/mods/stock_ar15_adar_wood_v1.mdl",
		bonemerge = false,
	...
	barrel = {
		model = "models/weapons/mods/barrel_ar15_370mm.mdl",
		bonemerge = false,
		bone = "mod_stock",
		pos = Vector(0, -9, 0),
		ang = Angle(0, -90, 0)
	...
	handguard = {
		model = "models/weapons/mods/handguard_ar15_adar_wood_v1.mdl",
		bonemerge = false,
		bone = "mod_reciever",
		pos = Vector(0, -0.26, 1),
		ang = Angle(0, 0, 0)
...
local path = "weapons/darsu_eft/m4/"
...
SWEP.animposmul = 2
SWEP.Primary.Sound = {"weapons/darsu_eft/m4a1/fire_new/adar_fire_outdoor_close.wav", 85, 90, 100}
SWEP.SupressedSound = {"weapons/darsu_eft/m4a1/fire_new/adar_fire_outdoor_silenced_close.wav", 65, 90, 100}
...
SWEP.LocalMuzzlePos = Vector(18, -1.7, 4.2)
SWEP.LocalMuzzleAng = Angle(0, 0, 0)
SWEP.WeaponEyeAngles = Angle(0, 0, 0)

SWEP.HoldType = "rpg"

SWEP.WepSelectIcon2 = Material("entities/arc9_eft_adar15.png")
SWEP.IconOverride = "entities/arc9_eft_adar15.png"
...
SWEP.availableAttachments = {
	...
	sight = {
		["mountType"] = {"picatinny"},
		["mount"] = {["picatinny"] = Vector(-18, 1.2, 0.045)},
	},
	magwell = {
