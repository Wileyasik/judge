...
SWEP.ZoomPos = Vector(0, -1.751, 6.6749)
...
SWEP.ModularParts = {
	receiver = {
		model = "models/weapons/mods/reciever_ar15_colt_m16a2_std.mdl",
		bonemerge = false,
		bone = "mod_reciever",
		pos = Vector(0, 0, 0),
		ang = Angle(0, -90, 0)
	...
	handguard = {
		model = "models/weapons/mods/handguard_ar15_colt_m16a2_std.mdl",
		bonemerge = false,
		bone = "mod_reciever",
		pos = Vector(0, -0.26, 1),
		ang = Angle(0, 0, 0)
	...
	handguard1 = {
		model = "models/weapons/mods/handguard_ar15_colt_m16a2_std_lower.mdl",
		bonemerge = false,
		bone = "mod_reciever",
		pos = Vector(0, -1.1, 1),
		ang = Angle(0, 0, 0)
