...
SWEP.PrintName = "M4A1 Mod3"
SWEP.Author = "Lone Star Arms"
SWEP.Instructions = "Lightweight assault rifle chambered in 5.56x45 mm\n\nRate of fire 600 rounds per minute"
...
SWEP.ModularParts = {
	receiver = {
		model = "models/weapons/mods/reciever_ar15_vltor_mur-1s.mdl",
		bonemerge = false,
		bone = "mod_reciever",
		pos = Vector(0, 0, 0),
		ang = Angle(0, -90, 0)
	...
	magazine = {
		model = "models/weapons/mods/mag_stanag_magpul_pmag_gen_m3_556x45_30.mdl",
		bonemerge = false,
		bone = "mod_magazine",
		pos = Vector(0, 1.1, 0),
		ang = Angle(0, -90, 0)
	...
	pistolgrip = {
		model = "models/weapons/mods/pistolgrip_ar15_hk_ergo_psg1_style_grip.mdl",
		bonemerge = false,
	...
	stock = {
		model = "models/weapons/mods/stock_ar15_rtm_atp_buffer_tube.mdl",
		bonemerge = false,
		bone = "mod_stock",
		pos = Vector(0, 0, 0),
		ang = Angle(0, -90, 0)
	...
	barrel = {
		model = "models/weapons/mods/barrel_ar15_centurion_arms_mk12_406mm.mdl",
		bonemerge = false,
		bone = "mod_stock",
		pos = Vector(0, -9, 0),
		ang = Angle(0, -90, 0)
...
SWEP.AttachmentPos = Vector(-3.5, 0, 0)
SWEP.AttachmentAng = Angle(0, 0, 0)
SWEP.FakeAttachment = "1"
SWEP.ZoomPos = Vector(0, -1.7726, 5.4312)
...
SWEP.LocalMuzzlePos = Vector(21.2, -1.7, 4.2)
SWEP.LocalMuzzleAng = Angle(0, 0, 0)
SWEP.WeaponEyeAngles = Angle(0, 0, 0)

SWEP.HoldType = "rpg"

SWEP.WepSelectIcon2 = Material("entities/arc9_eft_radian.png")
SWEP.IconOverride = "entities/arc9_eft_radian.png"
...
SWEP.StartAtt = {"holo21", "stock_ar15_dd_enhanced"}
SWEP.availableAttachments = {
	...
	sight = {
		...
		["mount"] = {["picatinny"] = Vector(-18, 1.2, 0.045), ["ironsight"] = Vector(-18, 1, 0.045)},
	},
	grip = {
