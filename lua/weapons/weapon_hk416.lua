...
SWEP.WorldModelFake = "models/weapons/c_hk416.mdl"
...
SWEP.ZoomPos = Vector(0, -1.7486, 6.913)
...
SWEP.ModularParts = {
	receiver = {
		model = "models/weapons/mods/reciever_ar15_hk_hk416a5_std.mdl",
		bonemerge = false,
		bone = "mod_reciever",
		pos = Vector(0, 0, 0),
		ang = Angle(0, -90, 0)
	...
	pistolgrip = {
		model = "models/weapons/mods/pistolgrip_ar15_aeroknox_orion.mdl",
		bonemerge = false,
	...
	stock = {
		model = "models/weapons/mods/stock_ar15_cmmg_mil_spec_tube.mdl",
		bonemerge = false,
		bone = "mod_stock",
		pos = Vector(0, 0, 0),
		ang = Angle(0, -90, 0)
	...
	barrel = {
		model = "models/weapons/mods/barrel_416_hk_419mm_556x45.mdl",
		bonemerge = false,
		bone = "mod_stock",
		pos = Vector(0, -9, 0),
		ang = Angle(0, -90, 0),
...
SWEP.animposmul = 2
SWEP.Primary.Sound = {"weapons/darsu_eft/m4a1/fire_new/hk416_outdoor_close_loop2.wav", 85, 90, 100}
SWEP.SupressedSound = {"weapons/darsu_eft/m4a1/fire_new/hk416_outdoor_silenced_close_loop4.wav", 65, 90, 100}
...
SWEP.LocalMuzzlePos = Vector(21.7, -1.7, 4.2)
SWEP.LocalMuzzleAng = Angle(0, 0, 0)
SWEP.WeaponEyeAngles = Angle(0, 0, 0)

SWEP.HoldType = "rpg"

SWEP.WepSelectIcon2 = Material("entities/arc9_eft_hk416.png")
SWEP.IconOverride = "entities/arc9_eft_hk416.png"
...
SWEP.availableAttachments = {
	...
	sight = {
		["mountType"] = {"picatinny"},
		["mount"] = {["picatinny"] = Vector(-18.5, 1.4, 0.050)},
	},
	grip = {
		["mount"] = {["picatinny"] = Vector(8, 0.2, 0.2)},
		["mountType"] = {"picatinny"},
		["mountAngle"] = Angle(0,0,0)
	},
	underbarrel = {
		["mount"] = Vector(5, -0.33, 0.2),
...
function SWEP:DrawModularParts()
	...
	local function positionPart(partName)
		...
		if isstring(partData.bodygroups) then
			model:SetBodyGroups(partData.bodygroups)
		elseif istable(partData.bodygroups) then
