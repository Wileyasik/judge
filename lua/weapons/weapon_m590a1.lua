...
SWEP.WorldModelFake = "models/weapons/c_m590_2.mdl"
SWEP.WorldModelReal = "models/weapons/c_m590_2.mdl"
...
function SWEP:ModelCreated(model) model:SetBodyGroups(self:GetRandomBodygroups() or "11221111") end
