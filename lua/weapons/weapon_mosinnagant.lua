...
SWEP.Primary.Damage = 59 -- Высокий урон для снайперки
...
-- AnimList для модели c_mosin.mdl
SWEP.AnimList = {
    ["idle"] = "idle",
    ...
    ["start"] = "bolt_open_0",
    ["start_empty"] = "bolt_open_0_empty",
    ["insert"] = "reload_insert",
    ["finish"] = "bolt_close_0",
    ["finish_empty"] = "bolt_close_0",
    ["inspect"] = "look",
...
-- Звуки анимаций для Mosin (исправленные названия)
local path = "weapons/darsu_eft/mosin/"
local randspin = {
    "arc9_eft_shared/weapon_generic_rifle_spin1.ogg",
    "arc9_eft_shared/weapon_generic_rifle_spin2.ogg",
    "arc9_eft_shared/weapon_generic_rifle_spin3.ogg",
    "arc9_eft_shared/weapon_generic_rifle_spin4.ogg",
    "arc9_eft_shared/weapon_generic_rifle_spin5.ogg",
    "arc9_eft_shared/weapon_generic_rifle_spin6.ogg",
    "arc9_eft_shared/weapon_generic_rifle_spin7.ogg",
    "arc9_eft_shared/weapon_generic_rifle_spin8.ogg",
    "arc9_eft_shared/weapon_generic_rifle_spin9.ogg",
    "arc9_eft_shared/weapon_generic_rifle_spin10.ogg"
}

-- Звуки анимаций для Mosin (с правильными путями)
local randspin = {
...
SWEP.AnimsEvents = {
    ...
    ["reload1"] = {
        [0] = function(self) self:EmitSound("weapons/tfa_ins2/k98/mosin_boltback.wav") end,
        [0.5] = function(self) self:EmitSound("weapons/tfa_ins2/k98/mosin_bulletin_1.wav") end,
        [1.2] = function(self) self:EmitSound("weapons/tfa_ins2/k98/mosin_boltforward.wav") end,
    },
    ["reload1t"] = {
        [0] = function(self) self:EmitSound("weapons/tfa_ins2/k98/mosin_boltback.wav") end,
        [0.5] = function(self) self:EmitSound("weapons/tfa_ins2/k98/mosin_bulletin_1.wav") end,
    ...
    -- Insert (вставка патрона)
    ["reload_insert"] = {
        [0.3] = function(self) self:EmitSound("weapons/tfa_ins2/k98/mosin_bulletin_" .. math.random(1, 4) .. ".wav") end,
    },
    
    -- Bolt close (конец перезарядки)
    ["bolt_close_0"] = {
