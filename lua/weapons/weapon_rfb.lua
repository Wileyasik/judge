...
SWEP.PrintName = "RFB"
SWEP.Author = "Kel-Tec"
SWEP.Instructions = "Semi-automatic bullpup rifle chambered in 7.62x51 NATO\n\nRate of fire ~250 rounds per minute"
...
SWEP.WorldModelFake = "models/weapons/c_rfb.mdl"
...
SWEP.FakeBodyGroups = "1111110"
SWEP.ZoomPos = Vector(0, -1.7702, 6.4954)
...
SWEP.ModularParts = {
	magazine = {
		model = "models/weapons/mods/mag_ar10_kac_steel_762x51_20.mdl",
		bonemerge = false,
		bone = "mod_magazine",
		pos = Vector(0, 8.2, -0.5),
		ang = Angle(0, 90, 0)
	},
}

SWEP.HeldMagOffsetPos = Vector(0, 0.6, 2)
...
SWEP.LocalMuzzlePos = Vector(16.2, -1.75, 4.4)
...
SWEP.WepSelectIcon2 = Material("entities/arc9_eft_rfb.png")
SWEP.IconOverride = "entities/arc9_eft_rfb.png"
...
SWEP.availableAttachments = {
	...
	sight = {
		["mountType"] = {"picatinny"},
		["mount"] = {["picatinny"] = Vector(-11, 1.75, 0.05)},
	},
}
