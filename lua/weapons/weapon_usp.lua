...
SWEP.Primary.Sound = {"weapons/darsu_eft/usp/usp_fire_close.ogg", 90, 90, 100}
SWEP.SupressedSound = {"weapons/darsu_eft/usp/usp_fire_silenced_close.ogg", 65, 90, 100}
