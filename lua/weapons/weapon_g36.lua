...
SWEP.WorldModelFake = "models/weapons/c_g36.mdl"


SWEP.ModularParts = {
	magazine = {
		model = "models/weapons/mods/mag_g36_30.mdl",
		bonemerge = false,
		bone = "mod_magazine",
		pos = Vector(0, -2.2, 0),
		ang = Angle(0, -90, 0)
...
SWEP.AttachmentPos = Vector(8.8, 0, 0)
SWEP.AttachmentAng = Angle(0, 0, 0)
SWEP.FakeAttachment = "1"
SWEP.FakeBodyGroups = "13151011230000"
SWEP.ZoomPos = Vector(0, -1.7568, 6.6029)
...
SWEP.AnimsEvents = {
	...
	["reload_empty0_0"] = {
		...
		[0.45] = function(self) self:EmitSound("weapons/darsu_eft/g36/g36_mag_in.ogg") end,
		[0.65] = function(self) self:EmitSound("weapons/darsu_eft/g36/g36_bolt_out_check.ogg") end,
		[0.75] = function(self) self:EmitSound("weapons/darsu_eft/g36/g36_bolt_in.ogg") end,
	},
}
...
SWEP.MagazineReloadAnimations = {
	mag2 = {"reload60", "reload_empty60_0"},
}
...
SWEP.animposmul = 2
SWEP.Primary.Sound = {"weapons/darsu_eft/g36/fire_new/g36_outdoor_close4.wav", 85, 90, 100}
SWEP.SupressedSound = {"weapons/darsu_eft/g36/fire_new/g36_outdoor_silenced_close3.wav", 65, 90, 100}
...
SWEP.LocalMuzzlePos = Vector(28.5, -1.75, 3.5)
...
SWEP.availableAttachments = {
	...
	sight = {
		["mountType"] = {"picatinny"},
		["mount"] = {["picatinny"] = Vector(-24.5, 2.6, 0.05)},
	},
	grip = {
		["mount"] = {["picatinny"] = Vector(4, 0, 0.15)},
		["mountType"] = {"picatinny"},
		["mountAngle"] = Angle(0,0,0)
	},
	underbarrel = {
		["mount"] = Vector(1, -0.4, 0.3),
