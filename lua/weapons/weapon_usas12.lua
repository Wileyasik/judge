...
SWEP.Author = "John Trevor Jr."
SWEP.Instructions = "The USAS-12 is a South Korean automatic shotgun designed for sustained firepower. It is gas-operated and selective-fire, notable for its large capacity, accepting both 10-round box and 20-round drum magazines, making it a powerful weapon for close combat and security roles."
...
SWEP.WorldModelFake = "models/weapons/a1.mdl" 
--PrintBones(Entity(1):GetActiveWeapon():GetWM())
--uncomment for funny
SWEP.FakePos = Vector(-12, 1, 6)
SWEP.FakeAng = Angle(0, 0, 0)
SWEP.AttachmentPos = Vector(3.8,2.1,-27.8)
SWEP.AttachmentAng = Angle(0,0,0)
SWEP.FakeAttachment = "1"
SWEP.FakeBodyGroups = "00900080302"
SWEP.ZoomPos = Vector(0, -1.8, 5.3866)

SWEP.WepSelectIcon2 = Material("entities/arccw_uc_a1.png")
SWEP.IconOverride = "entities/arccw_uc_a1.png"
...
SWEP.FakeReloadSounds = {
	...
	[0.62] = "weapons/darsu_eft/aa12/aa12_drum_in_0.ogg",
...
SWEP.FakeEmptyReloadSounds = {
	...
	--[0.95] = "weapons/ak74/ak74_boltback.wav",
	[0.83] = "weapons/darsu_eft/aa12/aa12_bolt_out.ogg",
	[0.90] = "weapons/ak74/ak74_boltrelease.wav",
	[1.01] = "weapons/ak74/ak74_boltback.wav",
}
...
SWEP.availableAttachments = {
	sight = {
		["mountType"] = {"",""},
		["mount"] = {[""] = Vector(-30, 6.02, 0),["picatinny"] = Vector(-30, 6.02, -0.100)},
	},
	mount = {
		["picatinny"] = {
			"mount3",
	...
	barrel = {
		[1] = {"supressor6", Vector(0,0.4,0.1), {}},
		[2] = {"supressor5", Vector(0,0,0), {}},
		["mount"] = Vector(-10.6,-0.12,-0.20),
	},
	grip = {
