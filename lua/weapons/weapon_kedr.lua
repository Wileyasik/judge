...
SWEP.Author = "Zlatoust"
SWEP.Instructions = "Submachine gun chambered in 9x18 mm PM\n\nRate of fire 900 rounds per minute"
...
SWEP.WorldModelFake = "models/weapons/c_kedr.mdl"


SWEP.ModularParts = {
	magazine = {
		model = "models/weapons/mods/mag_kedr_20.mdl",
		bonemerge = false,
		bone = "mod_magazine",
		pos = Vector(0, 0.7, 0),
		ang = Angle(0, -90, 0)
...
SWEP.FakePos = Vector(-9, 2.0, 7)
SWEP.FakeAng = Angle(0, 0, 0)
SWEP.AttachmentPos = Vector(-0.8, 0, 0)
SWEP.AttachmentAng = Angle(0, 0, 0)
SWEP.FakeAttachment = "1"
SWEP.FakeBodyGroups = "100101"
...
SWEP.MagModel = "models/weapons/mods/mag_kedr_20.mdl"
...
SWEP.LocalMuzzlePos = Vector(13.8, -2.4, 4.3)
SWEP.LocalMuzzleAng = Angle(0, 0, 0)
SWEP.WeaponEyeAngles = Angle(0, 0, 0)

SWEP.HoldType = "rpg"

SWEP.WepSelectIcon2 = Material("entities/arc9_eft_kedr.png")
SWEP.IconOverride = "entities/arc9_eft_kedr.png"
...
SWEP.Ergonomics = 1.3
SWEP.WorldPos = Vector(3, -0.5, -0.5)
...
SWEP.DistSound = path .. "kedr_fire_close.ogg"

-- tpik hand positions
SWEP.RHPos = Vector(3, -6, 3)
SWEP.RHAng = Angle(0, -8, 90)
SWEP.LHPos = Vector(9, 1, -2)
