...
SWEP.ModularParts = {
	receiver = {
		model = "models/weapons/mods/ak_dc_zenit_b33.mdl",
		bonemerge = false,
		bone = "weapon",
		pos = Vector(0, -19, 1.5),
		ang = Angle(0, 0, 0)
	...
	magazine = {
		model = "models/weapons/mods/mag_ak_us_palm_ak30_762x39_30.mdl",
		bonemerge = false,
		bone = "mod_magazine",
		pos = Vector(0, 0, -0.15),
		ang = Angle(0, 0, 0)
	...
	handguard = {
		model = "models/weapons/mods/ak_hg_b31c.mdl",
		bonemerge = false,
		bone = "weapon",
	...
	pistolgrip = {
		model = "models/weapons/mods/ak_pgrip_ags74_pro.mdl",
		bonemerge = false,
		bone = "weapon",
...
SWEP.ARC9DefaultLHIKSourceModel = "models/weapons/mods/ak_hg_b31c.mdl"
