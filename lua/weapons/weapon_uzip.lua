...
SWEP.WorldModelFake = "models/weapons/c_uzi_pro.mdl"

SWEP.ModularParts = {
	magazine = {
		model = "models/weapons/mods/mag_uzi_pro25.mdl",
		bonemerge = false,
		bone = "mod_magazine",
		pos = Vector(0, 2, -4),
		ang = Angle(0, -90, 0)
...
SWEP.HeldMagOffsetPos = Vector(0, 0, -1)
...
SWEP.FakeBodyGroups = "101001210"
SWEP.ZoomPos = Vector(0, -2.3002, 5.063)
...
local path = "weapons/darsu_eft/uzi_pro/"
...
SWEP.MagModel = "models/weapons/mods/mag_uzi_32.mdl"
...
SWEP.animposmul = 2
SWEP.Primary.Sound = {"weapons/darsu_eft/uzipro/fire_new/uzip_outdoor_close_loop1.wav", 85, 120, 130}
...
SWEP.LocalMuzzlePos = Vector(10, -2.3, 3.35)
...
SWEP.availableAttachments = {
	...
	sight = {
		["mountType"] = {"picatinny"},
		["mount"] = Vector(-5, 1.45, 0.05),
	},
}

SWEP.RHandPos = Vector(3, -1, 2)
SWEP.LHandPos = Vector(5, -1, 0)
SWEP.Penetration = 9
SWEP.Spray = {}
for i = 1, 30 do
...
SWEP.DistSound = path .. "uzipro_fire_close.ogg"

SWEP.RHPos = Vector(6, -5, 3)
SWEP.RHAng = Angle(0, -5, 90)
SWEP.LHPos = Vector(6, -0.5, -2.5)
