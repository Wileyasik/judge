...
local loadouts = {
	{primary = "weapon_glock17", attachments = {{"supressor4"},{"holo16","laser3"},{"laser1"},""}, armor = {"vest3","helmet1"}, ammo = 3},
	...
	{primary = "weapon_mk18", attachments = {{"grip1","supressor2"},{"holo5","grip3","supressor2"},{"laser4","grip2"},{"laser4","supressor2"}}, armor = {"vest4","helmet1"}, ammo = 3},
	{primary = "weapon_sr25", attachments = {{"laser2"},{"optic2"},{"holo8","supressor7"},{"holo5","supressor7"}}, armor = {"vest1","helmet1","nightvision1"}, ammo = 3},
	{primary = "weapon_ptrd", attachments = "", armor = {}, ammo = 12},
	{primary = "weapon_mp7", attachments = {{"supressor2"},{"holo5","supressor2"},{"laser4","supressor2"}}, armor = {"vest3","helmet1"}, ammo = 3},
	{primary = "weapon_p90", attachments = {{"supressor4"},{"laser1","supressor4"},{"holo14","supressor4"}}, armor = {"vest3","helmet1"}, ammo = 3},
	{primary = "weapon_mr43_short", attachments = "", armor = {"vest3","helmet1","mask1"}, ammo = 6},
	{primary = "weapon_akm", attachments = {{"holo6","supressor1"},{"holo4","laser1"},{"supressor1"}}, armor = {"vest1","helmet1","nightvision1"}, ammo = 3},
	{primary = "weapon_m4a1", attachments = {{"grip1","supressor2"},{"holo5","grip3","supressor2"},{"laser4","grip2"},{"laser4","supressor2"}}, armor = {"vest1","helmet1"}, ammo = 3},
	...
	{primary = "weapon_hk416", attachments = {{"grip1","supressor2"},{"holo5","grip3","supressor2"},{"laser4","grip2"},{"laser4","supressor2"}}, armor = {"vest1","helmet1"}, ammo = 3},
	{primary = "weapon_akAfgan", attachments = "", armor = {"vest1","helmet1"}, ammo = 3},
	{primary = "weapon_usp", attachments = "", armor = {"vest3","helmet1"}, ammo = 3},
	...
	{primary = "weapon_uzip", attachments = "", armor = {"vest3","helmet1"}, ammo = 3},
	{primary = "weapon_aug", attachments = {{"optic8"},{"holo3"},{"holo4"}}, armor = {"vest4","helmet1"}, ammo = 3},
	...
	{primary = "weapon_vpo136", attachments = {{"optic8"},{"holo6"}}, armor = {"vest3","helmet1"}, ammo = 4},
	...
	{primary = "weapon_m4a1", secondary = "weapon_p22", attachments = {{"grip1"},{"holo5","grip3"}}, armor = {"vest3","helmet1"}, ammo = 3, ammo2 = 2},
	...
	{primary = "weapon_remington700", secondary = "weapon_cz75", attachments = "", armor = {"vest3","helmet1"}, ammo = 4, ammo2 = 2},
	{primary = "weapon_vpo136", secondary = "weapon_px4beretta", attachments = {{"holo6"}}, armor = {"vest3","helmet1"}, ammo = 3, ammo2 = 2},
	...
	{primary = "weapon_vss", attachments = {{"supressor1"},{"laser2"},{"supressor1","holo4"}}, armor = {"vest1","helmet1"}, ammo = 3},
	{primary = "weapon_asval", attachments = {{"supressor1","holo4"},{"laser1"}}, armor = {"vest1","helmet1"}, ammo = 3},
	{primary = "weapon_ak12", attachments = {{"holo6"},{"optic8"},{"holo4"}}, armor = {"vest3","helmet1"}, ammo = 3},
	{primary = "weapon_g36", attachments = {{"optic2"},{"holo5"}}, armor = {"vest1","helmet1"}, ammo = 3},
	{primary = "weapon_mcx", attachments = {{"grip1"},{"holo5","grip3"},{"laser4","grip2"}}, armor = {"vest1","helmet1"}, ammo = 3},
	{primary = "weapon_scarl", attachments = {{"optic2"},{"holo5","grip3"}}, armor = {"vest1","helmet1"}, ammo = 3},
	{primary = "weapon_fn57", secondary = "weapon_p226", attachments = "", armor = {"vest3","helmet1"}, ammo = 4, ammo2 = 2},
	{primary = "weapon_m1911", attachments = "", armor = {"vest3","helmet1"}, ammo = 5},
	{primary = "weapon_sr1mp", attachments = "", armor = {"vest3","helmet1"}, ammo = 3},
	{primary = "weapon_svt", attachments = "", armor = {"vest3","helmet1"}, ammo = 5},
	{primary = "weapon_mdr", secondary = "weapon_pb", attachments = "", armor = {"vest1","helmet1"}, ammo = 4, ammo2 = 3},
	{primary = "weapon_ks23", attachments = "", armor = {"vest4","helmet1","mask1"}, ammo = 4},
}
...
function MODE:RoundStart()
	...
	for _, ply in player.Iterator() do
		...
		hg.AddArmor(ply, {"vest26","helmet8"})
